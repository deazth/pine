...
@section('content')
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-4">
            <div class="text-center mt-4"><img src="{{asset('assets/logo-4.png')}}" height="125"></div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <div class="text-center"><a class="text-success" href="{{ route('backpack.auth.login') }}">{{ trans('backpack::base.login') }}</a></div>
                </div>
            </div>
        </div>
    </div>
